defmodule GameSite.MultiPoker.HandEvaluatorTest do
  ...
  alias GameSite.MultiPoker.HandEvaluator
  ...
  describe "evaluate_hands/1" do
    test "orders players from best hand to worst hand" do
      room = %GameSite.MultiPoker.Room{
        ...
        players: %{
          1 => %GameSite.MultiPoker.Player{
            player_id: 1,
            hand: [{14, :clubs}, {10, :spades}]
          },
          2 => %GameSite.MultiPoker.Player{
            player_id: 2,
            hand: [{13, :hearts}, {13, :spades}]
          },
          3 => %GameSite.MultiPoker.Player{
            player_id: 3,
